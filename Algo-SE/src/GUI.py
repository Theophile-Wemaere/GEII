...
class nmea_gui:
    ...
    def __init__(self, root):
        ...
        button_start.place(x=181,y=420,width=118,height=30)
        ...
        label_choose["font"] = tkFont.Font(family='Times',size=12)
        label_choose["fg"] = "#333333"
        label_choose["justify"] = "center"
        label_choose["text"] = "Choose file"
        label_choose.place(x=40,y=40,width=70,height=25)
        ...
        label_settings["font"] = tkFont.Font(family='Times',size=12)
        label_settings["fg"] = "#333333"
        label_settings["justify"] = "center"
        label_settings["text"] = "Others settings"
        label_settings.place(x=40,y=200,width=106,height=30)
        ...
        label_bar2["bg"] = "black"
        label_bar2.place(x=20,y=230,width=430,height=2)
        ...
        checkBox_color.place(x=-100,y=260,width=400,height=30)
        ...
        self.label_color["text"] = "RGB color (hex) : "
        ...
        checkBox_name.place(x=2,y=320,width=400,height=30)
    ...
    def name_cb(self):
        ...
        if self.var_name.get() == 1:
            self.output_entry.place(x=150,y=360,width=200,height=30)
            self.label_output.place(x=50,y=360,width=100,height=32)
        else:
    ...
    def color_cb(self):
        ...
        if self.var_mode.get() == 1:
            self.color_entry.place(x=160,y=290,width=150,height=30)
            self.label_color.place(x=40,y=290,width=120,height=32)
            self.button_color.place(x=350,y=290,width=108,height=30)
        else:
